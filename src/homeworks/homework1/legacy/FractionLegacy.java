...
public class FractionLegacy {
	 ...
	 * @throws FractionLegacyException Throws if the denominator is 0.
	 */
	FractionLegacy (long numerator, long denominator) throws FractionLegacyException {
	 ...
	 * @throws FractionLegacyException Throws if the denominator is 0.
	 */
	FractionLegacy (String fraction) throws FractionLegacyException {
		if (!fraction.matches("-?\\d+(/-?\\d+|.\\d+)?"))
			throw new FractionLegacyException("The given string does not contain a legal fraction.");
	 ...
	 * @param fractionLegacy The Fraction object which is added to the this object in a new sum Fraction object (the this object is not modified).
	 * @return The sum of the this object and the given Fraction object as new Fraction object.
	 * @throws FractionLegacyException Throws if the given Fraction object is null.
	 */
	FractionLegacy add (FractionLegacy fractionLegacy) throws FractionLegacyException {
		if (fractionLegacy == null)
			throw new FractionLegacyException("The fraction to add must not be null.");
		FractionLegacy copy = this.copy();
		copy.addThis(fractionLegacy);
		return copy;
	}
	
	/**
	 * This method adds the given Fraction object to the this object.
	 * @param fractionLegacy The Fraction object which is added to the this object.
	 */
	void addThis (FractionLegacy fractionLegacy) {
		if (fractionLegacy != null) {
			long leastCommonMultiple = leastCommonMultiple(denominator, fractionLegacy.denominator);
			numerator = numerator * (leastCommonMultiple / denominator) + fractionLegacy.numerator * (leastCommonMultiple / fractionLegacy.denominator);
	 ...
	 * @param fractionLegacy The Fraction object which is subtracted from the this object in a new difference Fraction object (the this object is not modified).
	 * @return The difference of the this object and the given Fraction object as new Fraction object.
	 * @throws FractionLegacyException Throws if the given Fraction object is null.
	 */
	FractionLegacy sub (FractionLegacy fractionLegacy) throws FractionLegacyException {
		if (fractionLegacy == null)
			throw new FractionLegacyException("The fraction to subtract must not be null.");
		FractionLegacy copy = this.copy();
		copy.subThis(fractionLegacy);
		return copy;
	}
	
	/**
	 * This method subtracts the given Fraction object from the this object.
	 * @param fractionLegacy The Fraction object which is subtracted from the this object.
	 */
	void subThis (FractionLegacy fractionLegacy) {
		if (fractionLegacy != null) {
			long leastCommonMultiple = leastCommonMultiple(denominator, fractionLegacy.denominator);
			numerator = numerator * (leastCommonMultiple / denominator) - fractionLegacy.numerator * (leastCommonMultiple / fractionLegacy.denominator);
			denominator = leastCommonMultiple;
	 ...
	 * @param fractionLegacy The Fraction object which the this object is multiplied by in a new product Fraction object (the this object is not modified).
	 * @return The product of the this object and the given Fraction object as new Fraction object.
	 * @throws FractionLegacyException Throws if the given Fraction object is null or it's denominator is 0.
	 */
	FractionLegacy mul (FractionLegacy fractionLegacy) throws FractionLegacyException {
		if (fractionLegacy == null)
			throw new FractionLegacyException("The fraction to multiply with must not be null.");
		if (fractionLegacy.denominator == 0)
			throw new FractionLegacyException("The fraction to multiply with must not have the denominator 0.");
		FractionLegacy copy = this.copy();
		copy.mulThis(fractionLegacy);
		return copy;
	}
	
	/**
	 * This method multiplies the this object by the given Fraction object.
	 * @param fractionLegacy The Fraction object which the this object is multiplied by.
	 */
	void mulThis (FractionLegacy fractionLegacy) {
		if (fractionLegacy != null) {
			numerator *= fractionLegacy.numerator;
			denominator *= fractionLegacy.denominator;
			simplify();
		}
	}
	 ...
	 * @param fractionLegacy The Fraction object which the this object is divided by in a new quotient Fraction object (the this object is not modified).
	 * @return The quotient of the this object and the given Fraction object as new Fraction object.
	 * @throws FractionLegacyException Throws if the given Fraction object is null or it's numerator is 0.
	 */
	FractionLegacy div (FractionLegacy fractionLegacy) throws FractionLegacyException {
		if (fractionLegacy == null)
			throw new FractionLegacyException("The fraction to divide by must not be null.");
		if (fractionLegacy.numerator == 0)
			throw new FractionLegacyException("The fraction to divide by must not have the numerator 0.");
		FractionLegacy copy = this.copy();
		copy.divThis(fractionLegacy);
		return copy;
	}
	
	/**
	 * This method divides the this object by the given Fraction object.
	 * @param fractionLegacy The Fraction object which the this object is divided by.
	 * @throws FractionLegacyException Throws if the numerator of the given Fraction object is 0.
	 */
	void divThis (FractionLegacy fractionLegacy) throws FractionLegacyException {
		if (fractionLegacy != null) {
			if (fractionLegacy.numerator == 0)
				throw new FractionLegacyException("The fraction to divide by must not have the numerator 0.");
			numerator *= fractionLegacy.denominator;
			denominator *= fractionLegacy.numerator;
			simplify();
		}
	}
	 ...
	 */
	FractionLegacy pow (int exponent) throws FractionLegacyException {
		FractionLegacy copy = this.copy();
	 ...
	 * @throws FractionLegacyException Throws if the numerator of the given Fraction object is 0 and the exponent is negative.
	 */
	void powThis (int exponent) throws FractionLegacyException {
		if (numerator == 0 && exponent < 0)
			throw new FractionLegacyException("Can not take 0 to a negative power.");
		if (exponent >= 0) {
	 ...
	 */
	private FractionLegacy copy () throws FractionLegacyException {
		return new FractionLegacy(numerator, denominator);
	}
	...
	public static void setFractionFormat (boolean fractionFormat) {
		FractionLegacy.fractionFormat = fractionFormat;
	}
	 ...
	 * @throws FractionLegacyException Throws if the denominator is 0.
	 */
	private void setFraction (long numerator, long denominator) throws FractionLegacyException {
		if (denominator == 0)
			throw new FractionLegacyException("The denominator must not be 0.");
		this.numerator = numerator;
	...
	public boolean equals (Object o) {
		...
		FractionLegacy fractionLegacy = (FractionLegacy) o;
		simplify();
		fractionLegacy.simplify();
		return numerator == fractionLegacy.numerator &&
				denominator == fractionLegacy.denominator;
	}
...
class FractionLegacyException extends Exception {
	public FractionLegacyException (String message) {
		super(message);
	}
}
